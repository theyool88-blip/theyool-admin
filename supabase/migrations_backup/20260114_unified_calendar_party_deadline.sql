-- unified_calendar 뷰 수정: 당사자별 데드라인 정보 추가
-- 2026-01-14
--
-- 변경 내용:
-- 1. DEADLINE에 party_id, party_side, party_name, party_type_label 컬럼 추가
-- 2. 당사자별 데드라인 title에 당사자 측 표시
...
COMMENT ON VIEW unified_calendar IS '법원기일, 데드라인, 상담 통합 캘린더 뷰 (당사자별 데드라인 지원)';

-- 완료 메시지
DO $$
BEGIN
  RAISE NOTICE '✅ unified_calendar VIEW 업데이트 완료';
  RAISE NOTICE '   - 당사자별 데드라인 정보 추가 (party_id, party_side, deadline_party_name)';
  RAISE NOTICE '   - 데드라인 title에 당사자 측 표시 (원고측/피고측)';
END $$;
