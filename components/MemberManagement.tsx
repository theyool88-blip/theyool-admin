      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-sm font-semibold text-[var(--text-primary)]">팀원 관리</h2>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  ...
                  {openDropdown === member.id && (
                    <div className="absolute right-0 top-full mt-1 w-40 bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-lg shadow-lg z-10 py-1">
                      <button
