...
import { X, Download, ZoomIn, ZoomOut, ChevronLeft, ChevronRight, Info } from 'lucide-react';
...
export default function FilePreview({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative z-10 flex h-full w-full max-w-6xl flex-col rounded-2xl bg-white shadow-2xl">
        {/* Header */}
            ...
            {canNavigate && onNavigate && (
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="rounded-lg p-2 text-gray-600 transition-colors hover:bg-gray-100 disabled:opacity-30 disabled:hover:bg-transparent"
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {fileType === 'Image' && (
              <>
                ...
                <span className="min-w-[3.5rem] text-center text-sm text-gray-600">
                  {imageZoom}%
                </span>
                <button
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          {/* Info Sidebar */}
          {showInfo && (
            <div className="w-80 flex-shrink-0 border-l border-gray-200 bg-white p-6 overflow-y-auto">
              ...
              {/* Metadata Tags */}
              {(file.is_contract || file.client_visible) && (
        ...
        <div className="border-t border-gray-200 bg-gray-50 px-6 py-3">
          <div className="flex items-center justify-between text-xs text-gray-500">
            <div className="flex items-center gap-3">
              ...
              <span className="truncate">{file.r2_key.split('/').pop()}</span>
            </div>
          </div>
        </div>
      </div>
...
function PreviewContent({
  ...
  switch (fileType) {
    ...
    case 'Text':
      return (
        <div className="h-full w-full overflow-auto rounded-xl bg-white border border-gray-200 p-6 shadow-sm">
        ...
        <div className="flex flex-col items-center gap-6 text-center max-w-md">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-sm font-medium text-white shadow-sm transition-all hover:bg-blue-700 active:scale-95"
            >
